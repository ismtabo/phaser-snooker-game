export class AudioPlayer {
	...
	createAudios() {
		// Create sounds
		this.music = this.game.add.audio('applause');
		this.hitWall = this.game.add.audio('hitWall');
		this.droped = this.game.add.audio('droped');
		this.hitBall = this.game.add.audio('hitBall');
		this.cueHitBall = this.game.add.audio('cueHitBall');
		this.fault = this.game.add.audio('fault');
		this.no = this.game.add.audio('no');
