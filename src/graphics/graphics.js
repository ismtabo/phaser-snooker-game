...
export class SnookerGraphics {
	...
	createBalls() {
		...
		this.brown = new Ball(this.game, 243 + 30, 220 + 30, 'brown', this.coloredBallsCollisionGroup);
		this.blue = new Ball(this.game, 452 + 30, 217 + 30, 'blue', this.coloredBallsCollisionGroup);
		this.yellow = new Ball(this.game, 243 + 30, 305 + 30, 'yellow', this.coloredBallsCollisionGroup);
		this.black = new Ball(this.game, 816 + 30, 217 + 30, 'black', this.coloredBallsCollisionGroup);
	...
	createTarget(color) {
		var target = this.game.add.sprite(472, 728, color);
		target.anchor.set(.5);
		return target;
	}
	...
	createGaps() {
		...
		for (var i = 0; i < gapsPosisiotns.length; i++) {
			var gap = this.game.add.sprite(gapsPosisiotns[i].x - 136, gapsPosisiotns[i].y - 120, 'gap');
			this.game.physics.p2.enable(gap);
